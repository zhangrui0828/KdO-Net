...
test_arg.add_argument("--evaluate_input_folder", type=str, default=DATA_PATH + "evaluate/input_data/",
                      help='prefix for the input folder locations')
test_arg.add_argument("--evaluate_output_folder", type=str, default=DATA_PATH + "evaluate/output_data/",
...
test_arg.add_argument('--saved_model_dir', type=str, default=MODEL_PATH,
                      help='the directory of the pre-trained model')
test_arg.add_argument('--saved_model_evaluate', type=str, default='',
                      help='file name of the model to load')
# -----------------------------------------------------------------------------
# Training
train_arg = add_argument_group("Train")
train_arg.add_argument("--input_data_folder", type=str, default=DATA_PATH + "train/input_data/",
                       help='prefix for the input folder locations')
train_arg.add_argument("--output_data_folder", type=str, default=DATA_PATH + "train/output_data/",
                       help='prefix for the output folder locations')
train_arg.add_argument('--max_steps', type=int, default=40000, #2000
                       help='maximum number of training iterations')
train_arg.add_argument('--max_epochs', type=int, default=2,  #20
                       help='maximum number of training epochs')
train_arg.add_argument('--batch_size', type=int, default=256,
                       help='the number of training examples for each iteration')
train_arg.add_argument('--learning_rate', type=float, default=1.0,         ##default=1e-3
...
train_arg.add_argument('--save_accuracy_rate', type=int, default=100,     ##default=500
                       help='the frequency of saving the training and validation accuracy')
train_arg.add_argument('--margin', type=str, default='none',
...
train_arg.add_argument('--decay_rate', type=float, default=0.95,                   ##0.95
                       help='the rate of exponential learning rate decaying')
train_arg.add_argument('--decay_step', type=int, default=500,       ##default=5000
...
train_arg.add_argument('--training_data_folder', type=str, default=DATA_PATH + "train/trainingdata/",
                       help='location of the training data files')
train_arg.add_argument('--pretrained_model', type=str, default=MODEL_PATH + "32_dim/*.ckpt",
                       help='pretrained model which will be used if resume is activared')

# Validation
valid_arg = add_argument_group("Validation")
train_arg.add_argument('--validation_data_folder', type=str, default=DATA_PATH + "validation/validationData3Dmatch/",
